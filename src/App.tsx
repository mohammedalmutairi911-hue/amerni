      ...
      return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
          <div className="text-center max-w-sm">
            ...
            <p className="text-gray-500 mb-2">حدث خطأ</p>
            ...
            <button onClick={() => window.location.reload()}
              className="bg-primary-500 text-gray-900 font-bold px-6 py-3 rounded-xl">
              تحديث
            </button>
          </div>
        </div>
    ...
    if (!workerApproved) return (
      <div className="min-h-screen bg-gray-50 pt-14 flex items-center justify-center px-4">
        <div className="max-w-sm text-center bg-white border border-gray-200 rounded-2xl p-10">
          ...
          <p className="text-gray-400 text-sm leading-relaxed mb-6">فريق أمرني راح يراجع بياناتك ويوافق عليك قريباً.</p>
